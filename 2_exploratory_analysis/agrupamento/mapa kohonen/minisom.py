...
class MiniSom(object):
    ...
    def plot_map(self, nrows=1, ncols=1,feature_names = [], normalize_weights = True, um = False, um_val = [], size=(15,15)):
        ...
        if self.topology == 'rectangular':
            ...
            plt.tight_layout()
            plt.savefig("mapa_pesos.svg", format='svg')
            plt.show()
    ...
    def plot_winning(self, map_items, alias_label=str, colorize=None, label_color = None, size=(14, 14)):
        ...
        if label_color:
            ...
            plt.legend(handles=legend_elements, loc='center left', bbox_to_anchor=(1, .95), title="Falhas")
        plt.savefig("umatriz_real.svg", format='svg')
        plt.show()
