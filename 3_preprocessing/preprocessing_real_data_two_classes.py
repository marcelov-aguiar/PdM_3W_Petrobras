...
def run_preprocessing():
    ...
    df_preprocessing = ReplaceColumnDataFrame(const.TARGET, const.MAPPING_TWO_CLASSES).transform(df_preprocessing)

    df_preprocessing.to_parquet(manipulate_path.get_path_preprocessing_real_data_two_classes())
